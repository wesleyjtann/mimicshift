...
class EGGen:    
    ...
    #             ):
    def __init__(self, N, rw_len, walk_generator, n_conds, condgenerator_layers=[20], generator_layers=[50], discriminator_layers=[35], W_down_generator_size=128, W_down_discriminator_size=128, batch_size=128, sample_batch=128, condition_dim=42, gencond_iters=1, gen_iters=1, disc_iters=3, wasserstein_penalty=10, l2_penalty_generator=1e-7, l2_penalty_discriminator=5e-5, lr_gencond=0.01, lr_gen=0.0001, lr_disc=0.0001, noise_dim=16, noise_type="Gaussian", temp_start=5.0, min_temperature=0.5, temperature_decay=1-5e-5, seed=15, use_gumbel=True, legacy_generator=False, gpu_id=0, plot_show=True
        ):
    ...
    def train(self, A_orig, val_ones, val_zeros,  max_iters=50000, stopping=None, eval_transitions=15e6,
              transitions_per_iter=150000, max_patience=5, eval_every=500, plot_every=-1, save_directory="./snapshots_mimic",
        ...
        # ++ Add ++
        sample_many_count = 128 #1000 #10000
